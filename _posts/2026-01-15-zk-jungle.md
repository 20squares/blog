...
Building a system requires choosing the right flavor. For this post, we are focusing on quantum-resistant options and skipping over traditional Pairing-Based ZK-SNARKs. We want math that stays secure (and [compliant](https://blog.20squares.xyz/post-quantum)) even when quantum computers enter the chat.
